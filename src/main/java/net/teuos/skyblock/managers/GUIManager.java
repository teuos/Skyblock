...
import net.teuos.skyblock.interfaces.InventoryHandler;
...
public class GUIManager {
    ...
    private final Map<Inventory, InventoryHandler> activeInventories = new HashMap<Inventory, InventoryHandler>();
